  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="row">
          ...
          <div class="col">
              <div class="form-group col">
                <label hidden for="Reservation_id">reservation_id:</label>
                <input hidden type="number" class="form-control" name="reservation_id" id="reservation_id">
              </div>
          </div>
          </div>
            ...
            jQuery('#ajaxSubmit').click(function(e){
               ...
               jQuery.ajax({
                  ...
                  data: {
                    ...
                    //reservation_id: jQuery('#reservation_id').val(),
                  },

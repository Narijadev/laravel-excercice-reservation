    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="row">
              <div class="form-group col-md-4">
                <label for="Club">Prénom:</label>
                <input type="text" class="form-control" name="club" id="club">
              </div>
          </div>
          <div class="row">
             <div class="form-group col-md-4">
                <label for="Country">Né(e) - Année:</label>
                <input type="text" class="form-control" name="country" id="country">
              </div>
          </div>
          <div class="row">
            <div class="form-group col-md-4">
              <label for="Goal Score">Email:</label>
              <input type="text" class="form-control" name="score" id="score">
            </div>
          </div>
          <div class="row">
            <div class="form-group col-md-4">
              <label for="Goal Score">Tél.:</label>
              <input type="text" class="form-control" name="score" id="score">
            </div>
          </div>
      </div>
      <div class="modal-footer">
        ...
        <button  class="btn btn-success" id="ajaxSubmit">Eregistrer</button>
        </div>
    </div>
  </div>
</div>

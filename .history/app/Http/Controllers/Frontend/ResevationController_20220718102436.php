...
class ResevationController extends Controller{
    ...
    public function store(Request $request)
    {
        ...
        $goalscorer->lastname=$request->get('lastname');
        $goalscorer->firstname=$request->get('firstname');
        $goalscorer->birthdate=$request->get('birthdate');
        $goalscorer->email=$request->get('email');
        $goalscorer->save();
